...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab02.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=../../../../goil/templates/ lab02.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("lab02/tpl_app_config.c")

sourceList.append("lab02/tpl_dispatch_table.c")
sourceList.append("lab02/tpl_invoque.S")
sourceList.append("lab02/tpl_interrupts.c")
