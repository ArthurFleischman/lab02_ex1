...
#--- OIL file
oilSourceList.append("lab02.oil")
...
cSourceList.append(projfile.ProjectFile("lab02.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab02/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab02/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab02/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab02/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab_02_exe.hex from lab_02_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab_02_exe")
  postCommand.mCommand.append("lab_02_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab_02_exe on avr/arduino/uno\033[0m")
